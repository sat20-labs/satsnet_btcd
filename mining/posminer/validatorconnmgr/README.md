...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](https://pkg.go.dev/github.com/sat20-labs/satsnet_btcd/netsync)
...
```bash
$ go get -u github.com/sat20-labs/satsnet_btcd/netsync
```
