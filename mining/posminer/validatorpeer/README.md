...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](https://pkg.go.dev/github.com/sat20-labs/satsnet_btcd/peer)
...
```bash
$ go get -u github.com/sat20-labs/satsnet_btcd/peer
```

## Examples

* [New Outbound Peer Example](https://pkg.go.dev/github.com/sat20-labs/satsnet_btcd/peer#example-package--NewOutboundPeer)  
