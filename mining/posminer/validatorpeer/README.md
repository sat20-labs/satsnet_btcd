...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](https://pkg.go.dev/github.com/sat20-labs/satoshinet/peer)
...
```bash
$ go get -u github.com/sat20-labs/satoshinet/peer
```

## Examples

* [New Outbound Peer Example](https://pkg.go.dev/github.com/sat20-labs/satoshinet/peer#example-package--NewOutboundPeer)  
