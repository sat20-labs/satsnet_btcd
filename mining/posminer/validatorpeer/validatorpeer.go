...
type MessageListeners struct {
	...
	OnGetAddr func(p *ValidatorPeer, msg *wire.MsgGetAddr)

	// OnAddr is invoked when a peer receives an addr bitcoin message.
	OnAddr func(p *ValidatorPeer, msg *wire.MsgAddr)

	// OnAddrV2 is invoked when a peer receives an addrv2 bitcoin message.
	OnAddrV2 func(p *ValidatorPeer, msg *wire.MsgAddrV2)

	// OnPing is invoked when a peer receives a ping bitcoin message.
	OnPing func(p *ValidatorPeer, msg *wire.MsgPing)

	// OnPong is invoked when a peer receives a pong bitcoin message.
	OnPong func(p *ValidatorPeer, msg *wire.MsgPong)

	// OnAlert is invoked when a peer receives an alert bitcoin message.
	OnAlert func(p *ValidatorPeer, msg *wire.MsgAlert)

	// OnMemPool is invoked when a peer receives a mempool bitcoin message.
	OnMemPool func(p *ValidatorPeer, msg *wire.MsgMemPool)

	// OnTx is invoked when a peer receives a tx bitcoin message.
	OnTx func(p *ValidatorPeer, msg *wire.MsgTx)

	// OnBlock is invoked when a peer receives a block bitcoin message.
	OnBlock func(p *ValidatorPeer, msg *wire.MsgBlock, buf []byte)

	// OnCFilter is invoked when a peer receives a cfilter bitcoin message.
	OnCFilter func(p *ValidatorPeer, msg *wire.MsgCFilter)

	// OnCFHeaders is invoked when a peer receives a cfheaders bitcoin
	// message.
	OnCFHeaders func(p *ValidatorPeer, msg *wire.MsgCFHeaders)

	// OnCFCheckpt is invoked when a peer receives a cfcheckpt bitcoin
	// message.
	OnCFCheckpt func(p *ValidatorPeer, msg *wire.MsgCFCheckpt)

	// OnInv is invoked when a peer receives an inv bitcoin message.
	OnInv func(p *ValidatorPeer, msg *wire.MsgInv)

	// OnHeaders is invoked when a peer receives a headers bitcoin message.
	OnHeaders func(p *ValidatorPeer, msg *wire.MsgHeaders)

	// OnNotFound is invoked when a peer receives a notfound bitcoin
	// message.
	OnNotFound func(p *ValidatorPeer, msg *wire.MsgNotFound)

	// OnGetData is invoked when a peer receives a getdata bitcoin message.
	OnGetData func(p *ValidatorPeer, msg *wire.MsgGetData)

	// OnGetBlocks is invoked when a peer receives a getblocks bitcoin
	// message.
	OnGetBlocks func(p *ValidatorPeer, msg *wire.MsgGetBlocks)

	// OnGetHeaders is invoked when a peer receives a getheaders bitcoin
	// message.
	OnGetHeaders func(p *ValidatorPeer, msg *wire.MsgGetHeaders)

	// OnGetCFilters is invoked when a peer receives a getcfilters bitcoin
	// message.
	OnGetCFilters func(p *ValidatorPeer, msg *wire.MsgGetCFilters)

	// OnGetCFHeaders is invoked when a peer receives a getcfheaders
	// bitcoin message.
	OnGetCFHeaders func(p *ValidatorPeer, msg *wire.MsgGetCFHeaders)

	// OnGetCFCheckpt is invoked when a peer receives a getcfcheckpt
	// bitcoin message.
	OnGetCFCheckpt func(p *ValidatorPeer, msg *wire.MsgGetCFCheckpt)

	// OnFeeFilter is invoked when a peer receives a feefilter bitcoin message.
	OnFeeFilter func(p *ValidatorPeer, msg *wire.MsgFeeFilter)

	// OnFilterAdd is invoked when a peer receives a filteradd bitcoin message.
	OnFilterAdd func(p *ValidatorPeer, msg *wire.MsgFilterAdd)

	// OnFilterClear is invoked when a peer receives a filterclear bitcoin
	// message.
	OnFilterClear func(p *ValidatorPeer, msg *wire.MsgFilterClear)

	// OnFilterLoad is invoked when a peer receives a filterload bitcoin
	// message.
	OnFilterLoad func(p *ValidatorPeer, msg *wire.MsgFilterLoad)

	// OnMerkleBlock  is invoked when a peer receives a merkleblock bitcoin
	// message.
	OnMerkleBlock func(p *ValidatorPeer, msg *wire.MsgMerkleBlock)
	...
	OnVersion func(p *ValidatorPeer, msg *wire.MsgVersion) *wire.MsgReject

	// OnVerAck is invoked when a peer receives a verack bitcoin message.
	OnVerAck func(p *ValidatorPeer, msg *wire.MsgVerAck)

	// OnReject is invoked when a peer receives a reject bitcoin message.
	OnReject func(p *ValidatorPeer, msg *wire.MsgReject)

	// OnSendHeaders is invoked when a peer receives a sendheaders bitcoin
	// message.
	OnSendHeaders func(p *ValidatorPeer, msg *wire.MsgSendHeaders)

	// OnSendAddrV2 is invoked when a peer receives a sendaddrv2 message.
	OnSendAddrV2 func(p *ValidatorPeer, msg *wire.MsgSendAddrV2)
	...
	OnRead func(p *ValidatorPeer, bytesRead int, msg wire.Message, err error)
	...
	OnWrite func(p *ValidatorPeer, bytesWritten int, msg wire.Message, err error)
}
...
type Config struct {
	...
	IsLocal bool // is this a local peer
}
...
// ValidatorPeer provides a basic concurrent safe bitcoin peer for handling bitcoin
...
func (p *ValidatorPeer) String() string {
...
//
// This function is safe for concurrent access.
func (p *ValidatorPeer) UpdateLastBlockHeight(newHeight int32) {
	p.statsMtx.Lock()
...
//
// This function is safe for concurrent access.
func (p *ValidatorPeer) UpdateLastAnnouncedBlock(blkHash *chainhash.Hash) {
...
//
// This function is safe for concurrent access.
func (p *ValidatorPeer) AddKnownInventory(invVect *wire.InvVect) {
...
//
// This function is safe for concurrent access.
func (p *ValidatorPeer) StatsSnapshot() *StatsSnap {
	p.statsMtx.RLock()
...
//
// This function is safe for concurrent access.
func (p *ValidatorPeer) NA() *wire.NetAddressV2 {
	p.flagsMtx.Lock()
	na := p.na
	p.flagsMtx.Unlock()
...
//
// This function is safe for concurrent access.
func (p *ValidatorPeer) Addr() string {
...
//
// This function is safe for concurrent access.
func (p *ValidatorPeer) GetPeerAddrsList() []net.Addr {
	// The address doesn't change after initialization, therefore it is not
	// protected by a mutex.
	return p.addrsList
}
...
//
// This function is safe for concurrent access.
func (p *ValidatorPeer) Inbound() bool {
	return p.inbound
}
...
//
// This function is safe for concurrent access.
func (p *ValidatorPeer) Services() wire.ServiceFlag {
	p.flagsMtx.Lock()
	services := p.services
	p.flagsMtx.Unlock()
...
//
// This function is safe for concurrent access.
func (p *ValidatorPeer) UserAgent() string {
	p.flagsMtx.Lock()
	userAgent := p.userAgent
	p.flagsMtx.Unlock()
...
//
// This function is safe for concurrent access.
func (p *ValidatorPeer) LastAnnouncedBlock() *chainhash.Hash {
	p.statsMtx.RLock()
...
//
// This function is safe for concurrent access.
func (p *ValidatorPeer) LastPingNonce() uint64 {
	p.statsMtx.RLock()
	lastPingNonce := p.lastPingNonce
	p.statsMtx.RUnlock()
...
//
// This function is safe for concurrent access.
func (p *ValidatorPeer) LastPingTime() time.Time {
	p.statsMtx.RLock()
	lastPingTime := p.lastPingTime
	p.statsMtx.RUnlock()
...
//
// This function is safe for concurrent access.
func (p *ValidatorPeer) LastPingMicros() int64 {
	p.statsMtx.RLock()
	lastPingMicros := p.lastPingMicros
	p.statsMtx.RUnlock()
...
//
// This function is safe for concurrent access.
func (p *ValidatorPeer) VersionKnown() bool {
	p.flagsMtx.Lock()
...
//
// This function is safe for concurrent access.
func (p *ValidatorPeer) VerAckReceived() bool {
	p.flagsMtx.Lock()
...
//
// This function is safe for concurrent access.
func (p *ValidatorPeer) ProtocolVersion() uint32 {
	p.flagsMtx.Lock()
...
//
// This function is safe for concurrent access.
func (p *ValidatorPeer) LastBlock() int32 {
	p.statsMtx.RLock()
	lastBlock := p.lastBlock
	p.statsMtx.RUnlock()
...
//
// This function is safe for concurrent access.
func (p *ValidatorPeer) LastSend() time.Time {
...
//
// This function is safe for concurrent access.
func (p *ValidatorPeer) LastRecv() time.Time {
...
//
// This function is safe for concurrent access.
func (p *ValidatorPeer) LocalAddr() net.Addr {
...
//
// This function is safe for concurrent access.
func (p *ValidatorPeer) BytesSent() uint64 {
...
//
// This function is safe for concurrent access.
func (p *ValidatorPeer) BytesReceived() uint64 {
...
//
// This function is safe for concurrent access.
func (p *ValidatorPeer) TimeConnected() time.Time {
	p.statsMtx.RLock()
...
//
// This function is safe for concurrent access.
func (p *ValidatorPeer) TimeOffset() int64 {
	p.statsMtx.RLock()
	timeOffset := p.timeOffset
	p.statsMtx.RUnlock()
...
//
// This function is safe for concurrent access.
func (p *ValidatorPeer) StartingHeight() int32 {
	p.statsMtx.RLock()
	startingHeight := p.startingHeight
	p.statsMtx.RUnlock()
...
//
// This function is safe for concurrent access.
func (p *ValidatorPeer) WantsHeaders() bool {
	p.flagsMtx.Lock()
...
//
// This function is safe for concurrent access.
func (p *ValidatorPeer) IsWitnessEnabled() bool {
	p.flagsMtx.Lock()
...
func (p *ValidatorPeer) WantsAddrV2() bool {
	p.flagsMtx.Lock()
...
//
// This function is safe for concurrent access.
func (p *ValidatorPeer) PushRejectMsg(command string, code validatorcommand.RejectCode, reason string, wait bool) {
...
func (p *ValidatorPeer) handlePingMsg(msg *validatorcommand.MsgPing) {
...
func (p *ValidatorPeer) handlePongMsg(msg *validatorcommand.MsgPong) {
...
func (p *ValidatorPeer) readMessage() (validatorcommand.Message, []byte, error) {
...
func (p *ValidatorPeer) writeMessage(msg validatorcommand.Message) error {
	...
	log.Tracef("%v", newLogClosure(func() string {
		...
		n, err := validatorcommand.WriteMessageWithEncodingN(&buf, msg, p.ProtocolVersion(),
	...
	log.Debugf("**********WriteMessage (%s) to (%v): %d bytes written", msg.Command(), p.conn.RemoteAddr(), n)
...
func (p *ValidatorPeer) isAllowedReadError(err error) bool {
...
func (p *ValidatorPeer) shouldHandleReadError(err error) bool {
...
func (p *ValidatorPeer) maybeAddDeadline(pendingResponses map[string]time.Time, msgCmd string) {
...
func (p *ValidatorPeer) stallHandler() {
	...
	for {
		...
		case <-stallTicker.C:
			...
			for command, deadline := range pendingResponses {
				...
				log.Debugf("ValidatorPeer %s appears to be stalled or "+
...
cleanup:
	...
	log.Tracef("ValidatorPeer stall handler done for %s", p)
}

// inHandler handles all incoming messages for the peer.  It must be run as a
// goroutine.
func (p *ValidatorPeer) inHandler() {
	// The timer is stopped when a new message is received and reset after it
	// is processed.
	idleTimer := time.AfterFunc(idleTimeout, func() {
		log.Warnf("ValidatorPeer %s no answer for %s -- disconnecting", p, idleTimeout)
		p.Disconnect()
	})
...
out:
	...
	close(p.inQuit)
	log.Tracef("ValidatorPeer input handler done for %s", p)
}
...
func (p *ValidatorPeer) queueHandler() {
...
cleanup:
	...
	close(p.queueQuit)
	p.queueQuit = nil
	log.Tracef("ValidatorPeer queue handler done for %s", p)
}
...
// should be logged.
func (p *ValidatorPeer) shouldLogWriteError(err error) bool {
...
func (p *ValidatorPeer) outHandler() {
out:
	for {
		select {
...
cleanup:
	...
	close(p.outQuit)
	log.Tracef("ValidatorPeer output handler done for %s", p)
}

// pingHandler periodically pings the peer.  It must be run as a goroutine.
func (p *ValidatorPeer) pingHandler() {
...
//
// This function is safe for concurrent access.
func (p *ValidatorPeer) QueueMessage(msg validatorcommand.Message, doneChan chan<- struct{}) {
...
//
// This function is safe for concurrent access.
func (p *ValidatorPeer) QueueMessageWithEncoding(msg validatorcommand.Message, doneChan chan<- struct{}) {
...
//
// This function is safe for concurrent access.
func (p *ValidatorPeer) QueueInventory(invVect *wire.InvVect) {
...
//
// This function is safe for concurrent access.
func (p *ValidatorPeer) Connected() bool {
...
func (p *ValidatorPeer) Disconnect() {
...
func (p *ValidatorPeer) reconnect() {
	// Disconnect first
	if atomic.AddInt32(&p.disconnect, 1) != 1 {
		return
	}
...
func (p *ValidatorPeer) sendNextCommand() bool {
...
func (p *ValidatorPeer) readRemoteVersionMsg() error {
...
func (p *ValidatorPeer) processRemoteVerAckMsg(msg *validatorcommand.MsgPeerInfo) {
	p.flagsMtx.Lock()
...
// remote peer.
func (p *ValidatorPeer) localVersionMsg() (*validatorcommand.MsgGetInfo, error) {
...
func (p *ValidatorPeer) writeLocalVersionMsg() error {
...
func (p *ValidatorPeer) waitToFinishNegotiation(pver uint32) error {
...
func (p *ValidatorPeer) negotiateInboundProtocol() error {
...
func (p *ValidatorPeer) negotiateOutboundProtocol() error {
	if err := p.writeLocalVersionMsg(); err != nil {
		return err
	}
...
func (p *ValidatorPeer) start() error {
...
// Disconnect.
func (p *ValidatorPeer) WaitForDisconnect() {
	<-p.quit
}
...
func newPeerBase(origCfg *Config, inbound bool) *ValidatorPeer {
	// Default to the max supported protocol version if not specified by the
	// caller.
	cfg := *origCfg // Copy to avoid mutating caller.
	if cfg.ProtocolVersion == 0 {
		cfg.ProtocolVersion = MaxValidatorVersion
	}
...
func NewInboundPeer(cfg *Config) *ValidatorPeer {
...
func NewOutboundPeer(cfg *Config, addr string) (*ValidatorPeer, error) {
...
// ipv6 address will fail and may cause a nil-pointer-dereference. This
// includes hostnames and onion services.
func NewValidatorPeer(cfg *Config, addrs []net.Addr) (*ValidatorPeer, error) {
	p := newPeerBase(cfg, false)

	p.addrsList = make([]net.Addr, 0, len(addrs))
	p.addrsList = append(p.addrsList, addrs...)

	log.Debugf("NewValidatorPeer IP:")
...
// connection request.
func (p *ValidatorPeer) Connect() error {
	if p.addrsList == nil || len(p.addrsList) == 0 {
...
func (p *ValidatorPeer) initListeners() ([]net.Listener, error) {
...
// run as a goroutine.
func (p *ValidatorPeer) listenHandler(listener net.Listener) {
	log.Infof("***********Validator peer listening on %s", listener.Addr())
	log.Debugf("***********Will accept command from %v", listener.Addr())
	...
	for atomic.LoadInt32(&p.stop) == 0 {
		...
		log.Debugf("***********Will read  command from %s", conn.RemoteAddr())
		_, command, _, err := validatorcommand.ReadMessage(conn, p.ProtocolVersion(), p.cfg.ChainParams.Net)
		if err != nil {
			log.Errorf("***********Unable to read message: %v", err)
			return
		}
		log.Debugf("***********Received validator command [%v] from %s", command.Command(), conn.RemoteAddr())
