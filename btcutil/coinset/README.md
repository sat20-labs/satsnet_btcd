...
[![GoDoc](http://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/sat20-labs/satsnet_btcd/btcutil/coinset)
...
```bash
$ go get -u github.com/sat20-labs/satsnet_btcd/btcutil/coinset
```
