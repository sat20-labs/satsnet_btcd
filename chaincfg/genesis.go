	...
	TxIn: []*wire.TxIn{
		{
			...
			SignatureScript: []byte{
				...
				0xea, 0xbf, 0x3e, 0xc7, 0x6a, 0x32, 0x37, 0x65,
				0x35, 0x37, 0xcc, 0x0f, 0x11, 0xfa, 0xf4, 0xdf,
				0xd8, 0xc0, 0xe1, 0x00, 0x04, 0xca, 0x2f, 0x28,
				0x67, 0x08, 0xe9, 0x77, 0x83, 0xbb, 0xc3, 0xcd,
				0xb6, 0x28,
			},
			Sequence: 0xffffffff,
		},
...
var satsTestNetGenesisMerkleRoot = chainhash.Hash([chainhash.HashSize]byte{ // Make go vet happy.
	0x4c, 0x9c, 0x9f, 0x9c, 0xd6, 0x80, 0x77, 0x45,
	0x03, 0x85, 0x76, 0x5d, 0x61, 0x73, 0x7c, 0xa5,
	0x82, 0x03, 0x44, 0xb1, 0x51, 0xe6, 0xba, 0xce,
	0xc0, 0x48, 0xae, 0x62, 0xf6, 0x8f, 0xb0, 0x7e,
})

// satsTestNetGenesisHash is the hash of the first block in the block chain for the
// sattestsnet network.
var satsTestNetGenesisHash = chainhash.Hash{
	0x05, 0x1d, 0xe9, 0x35, 0xc9, 0x07, 0xdd, 0x00,
	0x8b, 0xc9, 0xc7, 0xc0, 0xae, 0xd7, 0x6b, 0xc9,
	0xa9, 0x7b, 0x5a, 0x1d, 0xcb, 0xd8, 0xb6, 0xb5,
	0x29, 0x92, 0x87, 0x82, 0xc7, 0x06, 0xd3, 0x3a,
}
...
var satsTestNetGenesisBlock = wire.MsgBlock{
	Header: wire.BlockHeader{
		...
		Timestamp:  time.Unix(1730686922, 0),     // 2024-11-04 10:22:02
		Bits:       0,                            // 0
		Nonce:      2398672412,
	},
