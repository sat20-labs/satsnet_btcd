...
* Install the MSI available at: [btcd windows installer](https://github.com/sat20-labs/satoshinet/releases)
...
```bash
git clone https://github.com/sat20-labs/satoshinet $GOPATH/src/github.com/sat20-labs/satoshinet
...
* [Using bootstrap.dat](https://github.com/sat20-labs/satoshinet/blob/master/docs/configuration.md#using-bootstrapdat)
