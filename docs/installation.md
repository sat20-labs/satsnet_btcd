...
* Install the MSI available at: [btcd windows installer](https://github.com/sat20-labs/satsnet_btcd/releases)
...
```bash
git clone https://github.com/sat20-labs/satsnet_btcd $GOPATH/src/github.com/sat20-labs/satsnet_btcd
...
* [Using bootstrap.dat](https://github.com/sat20-labs/satsnet_btcd/blob/master/docs/configuration.md#using-bootstrapdat)
