...
services:
  btcd:
    container_name: btcd
    hostname: btcd
    build: https://github.com/sat20-labs/satoshinet.git#master
    restart: unless-stopped
    volumes:
      - btcd-data:/root/.btcd
    ports:
