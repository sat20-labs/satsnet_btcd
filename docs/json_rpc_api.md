...
* Unlike bitcoind that has the wallet and chain intermingled in the same process
  ...
  [btcwallet](https://github.com/sat20-labs/satsnet_btcwallet).
...
such as [btcwallet](https://github.com/sat20-labs/satsnet_btcwallet) for inter-process
...
[rpcclient](https://github.com/sat20-labs/satsnet_btcd/tree/master/rpcclient) package.
...
[rpcclient](https://github.com/sat20-labs/satsnet_btcd/tree/master/rpcclient) package to connect with
